...
button.addEventListener("click",()=>{
    status.innerText==="The zip is open "? (status.innerTEXT="the zip is closed"):(status.innerText="The zip is open");
    button.innerText==="Open the zip"? button.innerText="Close the zip":button.innerText="Open the zip";
});
